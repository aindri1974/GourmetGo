...
export default function Header(){
    return (
        <header className="bg-[#ff5200] font-serif">
            <div className="flex justify-between container mx-auto py-8 px-6 max-w-[85%]">
                <img className="w-40 h-12" src="https://res.cloudinary.com/dutdah0l9/image/upload/v1720058694/Swiggy_logo_bml6he.png"></img>
                <div className="text-base font-bold flex gap-x-10 items-center text-white">
                    ...
                    <a className="border border-white py-3 px-4 rounded-2xl" href="https://www.swiggy.com/corporate/" target="_blank">Get The App</a>
                    <a className="border border-black bg-black py-3 px-8 rounded-2xl" href="https://www.swiggy.com/corporate/" target="_blank">Sign in</a>
                </div>
            </div>
